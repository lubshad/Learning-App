...
class RemoveCart extends UseCase<Map<String, dynamic>, RemoveCartParams> {
  final DataRepository _dataRepository;

  RemoveCart(this._dataRepository);
  @override
  Future<Either<AppError, Map<String, dynamic>>> call(
      RemoveCartParams params) async {
    ...
    return await _dataRepository.removeCartData(newParams);
  }
}
