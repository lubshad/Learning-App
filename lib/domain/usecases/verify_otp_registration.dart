...
class VerifyOtpRegistration extends UseCase<VerifyOtpResponse, AuthParams> {
  final AuthenticationRepository _authenticationRepository;

  VerifyOtpRegistration(this._authenticationRepository);
  @override
  Future<Either<AppError, VerifyOtpResponse>> call(AuthParams params) async {
    return await _authenticationRepository
        .verifyOtpRegistration(params.toMap());
  }
}
